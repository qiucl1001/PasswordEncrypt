...
s = i.WordArray = o.extend({
    ...
    concat: function(e) {
        ...
        r = e.words,
        i = this.sigBytes;
        if (e = e.sigBytes, this.clamp(), i % 4) for (t = 0; t < e; t++) n[i + t >>> 2] |= (r[t >>> 2] >>> 24 - 8 * (t % 4) & 255) << 24 - 8 * ((i + t) % 4);
        else if (65535 < r.length) for (t = 0; t < e; t += 4) n[i + t >>> 2] = r[t >>> 2];
...
u = a.Hex = {
    stringify: function(e) {
        var t, n, r, i;
        for (t = e.words, e = e.sigBytes, n = [], r = 0; r < e; r++) i = t[r >>> 2] >>> 24 - 8 * (r % 4) & 255,
...
l = a.Latin1 = {
    stringify: function(e) {
        for (var t = e.words,
        e = e.sigBytes,
        n = [], r = 0; r < e; r++) n.push(String.fromCharCode(t[r >>> 2] >>> 24 - 8 * (r % 4) & 255));
        return n.join("")
    },
    parse: function(e) {
        for (var t = e.length,
...
i = e.algo.SHA1 = t.extend({
    ...
    _doProcessBlock: function(e, t) {
        var n, i, o, s, a, u, l, c;
        for (n = this._hash.words, i = n[0], o = n[1], s = n[2], a = n[3], u = n[4], l = 0; 80 > l; l++) 16 > l ? r[l] = 0 | e[t + l] : (c = r[l - 3] ^ r[l - 8] ^ r[l - 14] ^ r[l - 16], r[l] = c << 1 | c >>> 31),
        c = (i << 5 | i >>> 27) + u + r[l],
