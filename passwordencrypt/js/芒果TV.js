...
function(i, t) {
    ...
    r = t.length,
    e = 0;
    for (; e < r;) s[e] = t.charCodeAt(e),
    e++;
    for (; s.length % i.chunkSize != 0;) s[e++] = 0;
    var g, n, d, u = s.length,
    o = "";
    for (e = 0; e < u; e += i.chunkSize) {
        for (d = new k, g = 0, n = e; n < e + i.chunkSize; ++g) d.digits[g] = s[n++],
        d.digits[g] += s[n++] << 8;
...
t.isNeg = i < 0,
i = Math.abs(i);
for (var s = 0; 0 < i;) t.digits[s++] = i & C,
i = Math.floor(i / E);
return t
}
function d(i) {
...
var s = new k;
s.digits[0] = t;
for (var r = L(i, s), e = u[r[1].digits[0]]; 1 == K(r[0], g);) r = L(r[0], s),
digit = r[1].digits[0],
e += u[r[1].digits[0]];
return (i.isNeg ? "-": "") + d(e)
}
...
function h(t) {
var s = "";
for (i = 0; i < 4; ++i) s += a[15 & t],
t >>>= 4;
return d(s)
}
function l(i) {
for (var t = "",
s = (B(i), B(i)); - 1 < s; --s) t += h(i.digits[s]);
return t
}
function N(i) {
...
for (var t = new k,
s = i.length,
r = 0; 0 < s; s -= 4, ++r) t.digits[r] = v(i.substr(Math.max(s - 4, 0), Math.min(s, 4)));
return t
}
function p(i, t) {
var s;
...
t.isNeg = !t.isNeg;
    ...
    s = new k;
    for (var r, e = 0,
    g = 0; g < i.digits.length; ++g) r = i.digits[g] + t.digits[g] + e,
    s.digits[g] = r % E,
    e = Number(E <= r);
    s.isNeg = i.isNeg
}
...
t.isNeg = !t.isNeg;
    ...
    var r, e;
    s = new k;
    for (var g = e = 0; g < i.digits.length; ++g) r = i.digits[g] - t.digits[g] + e,
    s.digits[g] = r % E,
    s.digits[g] < 0 && (s.digits[g] += E),
    e = 0 - Number(r < 0);
    if ( - 1 == e) {
        for (g = e = 0; g < i.digits.length; ++g) r = 0 - s.digits[g] + e,
        s.digits[g] = r % E,
        s.digits[g] < 0 && (s.digits[g] += E),
        e = 0 - Number(r < 0);
        s.isNeg = !i.isNeg
...
r = i.digits[s],
e = (s + 1) * D;
for (t = e; e - D < t && 0 == (32768 & r); --t) r <<= 1;
return t
}
function w(i, t) {
for (var s, r, e, g = new k,
n = B(i), d = B(t), u = 0; u <= d; ++u) {
    for (s = 0, e = u, j = 0; j <= n; ++j, ++e) r = g.digits[e] + i.digits[j] * t.digits[u] + s,
    g.digits[e] = r & C,
    s = r >>> o;
    g.digits[u + n + 1] = s
}
...
result = new k,
s = B(i);
for (var g = r = 0; g <= s; ++g) e = result.digits[g] + i.digits[g] * t + r,
result.digits[g] = e & C,
r = e >>> o;
...
for (var g = Math.min(t + e, i.length), n = t, d = r; n < g; ++n, ++d) s[d] = i[n]
}
...
g = D - e,
n = r.digits.length - 1,
d = n - 1; 0 < n; --n, --d) r.digits[n] = r.digits[n] << e & C | (r.digits[d] & z[e]) >>> g;
...
g = D - e,
n = 0,
d = n + 1; n < r.digits.length - 1; ++n, ++d) r.digits[n] = r.digits[n] >>> e | (r.digits[d] & P[e]) << g;
...
g = S(t),
n = t.isNeg;
if (e < g) return i.isNeg ? ((s = y(A)).isNeg = !t.isNeg, i.isNeg = !1, t.isNeg = !1, r = F(t, i), i.isNeg = !0, t.isNeg = n) : (s = new k, r = y(i)),
new Array(s, r);
s = new k,
r = i;
for (var d = Math.ceil(g / D) - 1, u = 0; t.digits[d] < b;) t = q(t, 1),
++u,
++g,
d = Math.ceil(g / D) - 1;
r = q(r, u),
...
for (var h = o; d < h; --h) {
    ...
    m = f * E * E + (l * E + N); (r = F(r, x(a = H(t, h - d - 1), s.digits[h - d - 1]))).isNeg && (r = p(r, a), --s.digits[h - d - 1])
}
return r = G(r, u),
s.isNeg = i.isNeg != n,
i.isNeg && (s = n ? p(s, A) : F(s, A), r = F(t = G(t, u), r)),
...
var t, s, r = new k;
r.digits[2 * this.k] = 1,
this.mu = (t = r, s = this.modulus, L(t, s)[0]),
this.bkplus1 = new k,
...
for (var r = 0 <= K(s, this.modulus); r;) r = 0 <= K(s = F(s, this.modulus), this.modulus);
return s
}
function R(i, t) {
var s = w(i, t);
...
s.digits[0] = 1;
for (var r = i,
e = t; 0 != (1 & e.digits[0]) && (s = this.multiplyMod(s, r)), 0 != (e = G(e, 1)).digits[0] || 0 != B(e);) r = this.multiplyMod(r, r);
return s
}