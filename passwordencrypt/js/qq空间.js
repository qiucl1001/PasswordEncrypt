...
$ = window.$ || {}, $pt = window.$pt || {}, $.RSA = $pt.RSA = function() {
    ...
    function $(t) {
        ...
        if (r-- > 0) for (s < this.DB && (i = this[r] >> s) > 0 && (o = !0, p = u(i)); r >= 0;)
        ...
        if (!(n.t <= 0)) {
            ...
            if (0 != g) {
                ...
                for (; --$ >= 0;) {
                    ...
                    if ((i[_] += p.am(0, y, i, $, 0, u)) < y) for (p.dlShiftTo($, v), i.subTo(v, i); i[_] < --y;)
                    i.subTo(v, i)
                }
    ...
    function W(t, e) {
        var i;
        return i = t < 256 || e.isEven() ? new A(e) : new H(e), this.exp(t, i)
    }
    ...
    for (rt = "A".charCodeAt(0), st = 10; st < 36; ++st)
    lt[rt++] = st;
    A.prototype.convert = I, A.prototype.revert = M, A.prototype.reduce = Q, A.prototype.mulTo = D, A.prototype.sqrTo = B, H.prototype.convert = O, H.prototype.revert = V, H.prototype.reduce = j, H.prototype.mulTo = F, H.prototype.sqrTo = R, r.prototype.copyTo = d, r.prototype.fromInt = h, r.prototype.fromString = m, r.prototype.clamp = _, r.prototype.dlShiftTo = q, r.prototype.drShiftTo = S, r.prototype.lShiftTo = C, r.prototype.rShiftTo = T, r.prototype.subTo = x, r.prototype.multiplyTo = L, r.prototype.squareTo = N, r.prototype.divRemTo = E, r.prototype.invDigit = U, r.prototype.isEven = G, r.prototype.exp = z, r.prototype.toString = $, r.prototype.negate = v, r.prototype.abs = y, r.prototype.compareTo = w, r.prototype.bitLength = b, r.prototype.mod = P, r.prototype.modPowInt = W, r.ZERO = f(0), r.ONE = f(1);
    var ct, ut, gt;
    if (null == ut) {
        ut = new Array, gt = 0;
        var dt;
...
function(t) {
    ...
    function l(t) {
        ...
        if ($ = g(t), m = 7 & $[0], (e = n - m - 10) < 0) return null;
        for (var o = 0; o < i.length; o++)
        i[o] = 0;
        w = new Array(e), y = 0, v = 8, m++;
        for (var p = 1; p <= 2;)
        if (m < 8 && (m++, p++), 8 == m && (i = t, !d())) return null;
        for (var o = 0; 0 != e;)
        if (m < 8 && (w[o] = 255 & (i[y + m] ^ $[m]), o++, e--, m++), 8 == m && (i = t, y = v - 8, !d())) return null;
        for (p = 1; p < 8; p++) {
            if (m < 8) {
...
function getPwd(pwd) {
    ...
    return $.Encryption.getEncryption(pwd, uin2hex("123456"), "@yvd", undefined);
}
