...
function get_password(username, password, captcha) {
e = {
    username: username,
    password: password,
    captcha: captcha,
    check_n: "rpKhOlzJg16T7bDclspqteGJJVpQZU4xU3GmgkS3Df7k8fBiBv?nczgfc4/ehW1CSq+wzZYNbT0JBfu8RUVlunAbWnJIWJIgG8=",
    check_e: "AQAB"
};
q = e.check_n;
l = e.check_e;
